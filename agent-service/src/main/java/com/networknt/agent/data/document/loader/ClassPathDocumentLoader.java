...
import com.networknt.agent.data.document.DocumentLoader;
...
import com.networknt.agent.data.document.source.ClassPathSource;
import java.io.File;
...
public class ClassPathDocumentLoader {
     ...
     * The default {@code DocumentParser} is loaded through SPI (see {@link com.networknt.agent.spi.data.document.parser.DocumentParserFactory DocumentParserFactoru}).
