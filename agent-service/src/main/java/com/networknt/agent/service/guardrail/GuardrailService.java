...
import com.networknt.agent.service.guardrail.spi.GuardrailServiceBuilderFactory;
...
public interface GuardrailService {
     ...
     * <p>
     *     Attempts to retrieve an instance through a {@link com.networknt.agent.service.guardrail.spi.GuardrailServiceBuilderFactory}, if available.
    ...
    interface Builder {
         ...
         */
        Builder inputGuardrailsConfig(com.networknt.agent.guardrail.config.InputGuardrailsConfig config);
         ...
         * @throws IllegalArgumentException if {@code config} is null.
         */
        Builder outputGuardrailsConfig(com.networknt.agent.guardrail.config.OutputGuardrailsConfig config);
