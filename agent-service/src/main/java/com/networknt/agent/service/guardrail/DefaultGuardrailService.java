...
final class DefaultGuardrailService extends AbstractGuardrailService {
    ...
    Optional<com.networknt.agent.guardrail.config.InputGuardrailsConfig> getInputConfig(String methodName) {
        return findMethod(methodName).flatMap(super::getInputConfig);
    }

    Optional<com.networknt.agent.guardrail.config.OutputGuardrailsConfig> getOutputConfig(String methodName) {
