package com.networknt.agent.service.guardrail;

import static com.networknt.agent.internal.ValidationUtils.ensureNotNull;

import com.networknt.agent.classinstance.ClassInstanceLoader;
import com.networknt.agent.classloading.ClassMetadataProvider;
...
import com.networknt.agent.service.guardrail.GuardrailService.Builder;
import com.networknt.agent.spi.classloading.ClassMetadataProviderFactory;
...
final class GuardrailServiceBuilder implements Builder {
    ...
    private com.networknt.agent.guardrail.config.InputGuardrailsConfig inputGuardrailsConfig;
    private com.networknt.agent.guardrail.config.OutputGuardrailsConfig outputGuardrailsConfig;
     ...
     */
    @Override
    public Builder inputGuardrailsConfig(com.networknt.agent.guardrail.config.InputGuardrailsConfig config) {
     ...
     */
    @Override
    public Builder outputGuardrailsConfig(com.networknt.agent.guardrail.config.OutputGuardrailsConfig config) {
    ...
    private static com.networknt.agent.guardrail.config.InputGuardrailsConfig computeConfig(InputGuardrails annotation) {
        return com.networknt.agent.guardrail.config.InputGuardrailsConfig.builder().build();
    }

    private static com.networknt.agent.guardrail.config.OutputGuardrailsConfig computeConfig(OutputGuardrails annotation) {

        return com.networknt.agent.guardrail.config.OutputGuardrailsConfig.builder()
