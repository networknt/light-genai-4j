...
import static com.networknt.agent.model.output.FinishReason.TOOL_EXECUTION;
import static com.networknt.agent.service.AiServiceParamsUtil.chatRequestParameters;
import static com.networknt.agent.service.AiServiceParamsUtil.findArgumentOfType;
import static com.networknt.agent.service.AiServiceValidation.validateParameters;
import static com.networknt.agent.service.IllegalConfigurationException.illegalConfiguration;
import static com.networknt.agent.service.TypeUtils.getRawClass;
import static com.networknt.agent.service.TypeUtils.isImageType;
import static com.networknt.agent.service.TypeUtils.resolveFirstGenericParameterClass;
import static com.networknt.agent.service.TypeUtils.typeHasRawClass;
...
import com.networknt.agent.invocation.LangChain4jManaged;
...
import com.networknt.agent.model.input.PromptTemplate;
...
import com.networknt.agent.rag.AugmentationRequest;
...
import com.networknt.agent.service.memory.ChatMemoryAccess;
import com.networknt.agent.service.memory.ChatMemoryService;
import com.networknt.agent.service.output.ServiceOutputParser;
import com.networknt.agent.service.tool.ToolServiceContext;
import com.networknt.agent.service.tool.ToolServiceResult;
import com.networknt.agent.spi.services.TokenStreamAdapter;
...
class DefaultAiServices<T> extends AiServices<T> {
    ...
    private static final Set<Class<? extends Annotation>> VALID_PARAM_ANNOTATIONS =
            Set.of(com.networknt.agent.service.UserMessage.class, V.class, MemoryId.class, UserName.class);
    ...
    private Optional<String> findSystemMessageTemplate(Object memoryId, Method method) {
        com.networknt.agent.service.SystemMessage annotation =
                method.getAnnotation(com.networknt.agent.service.SystemMessage.class);
        if (annotation != null) {
    ...
    private static boolean hasContentArgument(Method method, Object[] args) {
        ...
        for (int i = 0; i < parameters.length; i++) {
            if (parameters[i].isAnnotationPresent(com.networknt.agent.service.UserMessage.class)) {
    ...
    private static Optional<String> findUserMessageTemplateFromMethodAnnotation(Method method) {
        return Optional.ofNullable(method.getAnnotation(com.networknt.agent.service.UserMessage.class))
