...
/**
 * An annotation to apply guardrails to the output of the model using the declarative {@link com.networknt.agent.service.AiServices AiServices}
 * approach.
 * <p>
...
public @interface OutputGuardrails {
     ...
     * </p>
     * @see com.networknt.agent.guardrail.config.OutputGuardrailsConfig#maxRetries()
     */
    int maxRetries() default com.networknt.agent.guardrail.config.OutputGuardrailsConfig.MAX_RETRIES_DEFAULT;
}
