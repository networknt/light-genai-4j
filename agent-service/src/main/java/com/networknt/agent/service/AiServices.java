...
import com.networknt.agent.exception.ToolArgumentsException;
import com.networknt.agent.exception.ToolExecutionException;
...
import com.networknt.agent.service.tool.DefaultToolExecutor;
...
import com.networknt.agent.spi.services.AiServicesFactory;
...
public abstract class AiServices<T> {
     ...
     * <p>
     *     Configuring this way is exactly the same as using the {@link com.networknt.agent.service.guardrail.InputGuardrails InptputGuardrails}
     ...
     *     to the caller, wrapped into a {@link com.networknt.agent.guardrail.GuardrailException GuardrailException}.
     * </p>
     * <p>
     ...
     * <p>
     *     Configuring this way is exactly the same as using the {@link com.networknt.agent.service.guardrail.OutputGuardrails OutputGuardrails}
     *     annotation at the class level. Using the annotation takes precedence.
     * </p>
     * <p>
