...
/**
 * An annotation to apply input guardrails to the input of the model using the declarative {@link com.networknt.agent.service.AiServices AiServices} approach.
 * <p>
