...
import com.networknt.genai.data.document.source.ClassPathSource;
import java.io.File;
...
public class ClassPathDocumentLoader {
     ...
     * The default {@code DocumentParser} is loaded through SPI (see {@link com.networknt.genai.spi.data.document.parser.DocumentParserFactory DocumentParserFactoru}).
