...
import static com.networknt.genai.spi.ServiceHelper.loadFactory;
...
import com.networknt.genai.exception.ToolArgumentsException;
import com.networknt.genai.exception.ToolExecutionException;
...
import com.networknt.genai.memory.chat.ChatMemoryProvider;
...
import com.networknt.genai.service.tool.BeforeToolExecution;
import com.networknt.genai.service.tool.DefaultToolExecutor;
...
import com.networknt.genai.spi.services.AiServicesFactory;
...
public abstract class AiServices<T> {
     ...
     * <p>
     *     Configuring this way is exactly the same as using the {@link com.networknt.genai.service.guardrail.InputGuardrails InptputGuardrails}
     ...
     *     to the caller, wrapped into a {@link com.networknt.genai.guardrail.GuardrailException GuardrailException}.
     * </p>
     * <p>
     ...
     * <p>
     *     Configuring this way is exactly the same as using the {@link com.networknt.genai.service.guardrail.OutputGuardrails OutputGuardrails}
     *     annotation at the class level. Using the annotation takes precedence.
     * </p>
     * <p>
