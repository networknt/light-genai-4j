...
/**
 * An annotation to apply input guardrails to the input of the model using the declarative {@link com.networknt.genai.service.AiServices AiServices} approach.
 * <p>
