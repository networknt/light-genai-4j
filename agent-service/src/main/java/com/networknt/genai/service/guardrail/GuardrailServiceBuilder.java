...
import com.networknt.genai.classinstance.ClassInstanceLoader;
import com.networknt.genai.classloading.ClassMetadataProvider;
...
import com.networknt.genai.service.guardrail.GuardrailService.Builder;
import com.networknt.genai.spi.classloading.ClassMetadataProviderFactory;
...
final class GuardrailServiceBuilder implements Builder {
    ...
    private com.networknt.genai.guardrail.config.InputGuardrailsConfig inputGuardrailsConfig;
    private com.networknt.genai.guardrail.config.OutputGuardrailsConfig outputGuardrailsConfig;
     ...
     */
    @Override
    public Builder inputGuardrailsConfig(com.networknt.genai.guardrail.config.InputGuardrailsConfig config) {
     ...
     */
    @Override
    public Builder outputGuardrailsConfig(com.networknt.genai.guardrail.config.OutputGuardrailsConfig config) {
    ...
    private static com.networknt.genai.guardrail.config.InputGuardrailsConfig computeConfig(InputGuardrails annotation) {
        return com.networknt.genai.guardrail.config.InputGuardrailsConfig.builder().build();
    }

    private static com.networknt.genai.guardrail.config.OutputGuardrailsConfig computeConfig(OutputGuardrails annotation) {

        return com.networknt.genai.guardrail.config.OutputGuardrailsConfig.builder()
