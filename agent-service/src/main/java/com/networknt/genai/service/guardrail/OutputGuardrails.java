...
/**
 * An annotation to apply guardrails to the output of the model using the declarative {@link com.networknt.genai.service.AiServices AiServices}
 * approach.
 * <p>
...
public @interface OutputGuardrails {
     ...
     * </p>
     * @see com.networknt.genai.guardrail.config.OutputGuardrailsConfig#maxRetries()
     */
    int maxRetries() default com.networknt.genai.guardrail.config.OutputGuardrailsConfig.MAX_RETRIES_DEFAULT;
}
