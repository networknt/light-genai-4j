...
final class DefaultGuardrailService extends AbstractGuardrailService {
    ...
    Optional<com.networknt.genai.guardrail.config.InputGuardrailsConfig> getInputConfig(String methodName) {
        return findMethod(methodName).flatMap(super::getInputConfig);
    }

    Optional<com.networknt.genai.guardrail.config.OutputGuardrailsConfig> getOutputConfig(String methodName) {
