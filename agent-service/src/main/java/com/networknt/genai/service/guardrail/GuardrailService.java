...
import com.networknt.genai.service.guardrail.spi.GuardrailServiceBuilderFactory;
...
public interface GuardrailService {
     ...
     * <p>
     *     Attempts to retrieve an instance through a {@link com.networknt.genai.service.guardrail.spi.GuardrailServiceBuilderFactory}, if available.
    ...
    interface Builder {
         ...
         */
        Builder inputGuardrailsConfig(com.networknt.genai.guardrail.config.InputGuardrailsConfig config);
         ...
         * @throws IllegalArgumentException if {@code config} is null.
         */
        Builder outputGuardrailsConfig(com.networknt.genai.guardrail.config.OutputGuardrailsConfig config);
