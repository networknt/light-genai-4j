...
import static com.networknt.genai.service.AiServiceParamsUtil.chatRequestParameters;
import static com.networknt.genai.service.AiServiceParamsUtil.findArgumentOfType;
import static com.networknt.genai.service.AiServiceValidation.validateParameters;
import static com.networknt.genai.service.IllegalConfigurationException.illegalConfiguration;
import static com.networknt.genai.service.TypeUtils.getRawClass;
import static com.networknt.genai.service.TypeUtils.isImageType;
...
import com.networknt.genai.service.memory.ChatMemoryAccess;
import com.networknt.genai.service.memory.ChatMemoryService;
import com.networknt.genai.service.output.ServiceOutputParser;
import com.networknt.genai.service.tool.ToolServiceContext;
import com.networknt.genai.service.tool.ToolServiceResult;
import com.networknt.genai.spi.services.TokenStreamAdapter;
...
class DefaultAiServices<T> extends AiServices<T> {
    ...
    private static final Set<Class<? extends Annotation>> VALID_PARAM_ANNOTATIONS =
            Set.of(com.networknt.genai.service.UserMessage.class, V.class, MemoryId.class, UserName.class);
    ...
    private Optional<String> findSystemMessageTemplate(Object memoryId, Method method) {
        com.networknt.genai.service.SystemMessage annotation =
                method.getAnnotation(com.networknt.genai.service.SystemMessage.class);
        if (annotation != null) {
    ...
    private static boolean hasContentArgument(Method method, Object[] args) {
        ...
        for (int i = 0; i < parameters.length; i++) {
            if (parameters[i].isAnnotationPresent(com.networknt.genai.service.UserMessage.class)) {
    ...
    private static Optional<String> findUserMessageTemplateFromMethodAnnotation(Method method) {
        return Optional.ofNullable(method.getAnnotation(com.networknt.genai.service.UserMessage.class))
