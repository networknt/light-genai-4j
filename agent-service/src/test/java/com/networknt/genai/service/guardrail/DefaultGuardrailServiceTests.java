...
class DefaultGuardrailServiceTests {
    ...
    void classLevelGuardrailsNoBuilders() {
        ...
        assertThat(guardrailService.getOutputConfig("chat"))
                .get()
                .extracting(com.networknt.genai.guardrail.config.OutputGuardrailsConfig::maxRetries)
                .isEqualTo(com.networknt.genai.guardrail.config.OutputGuardrailsConfig.MAX_RETRIES_DEFAULT);
                ...
                Arguments.of(
                        ...
                        GuardrailService.builder(MethodLevelAssistant1.class)
                                ...
                                .outputGuardrailsConfig(
                                        com.networknt.genai.guardrail.config.OutputGuardrailsConfig.builder()
                                                .maxRetries(10)
                                                .build())
                                .build()),
                Arguments.of(
