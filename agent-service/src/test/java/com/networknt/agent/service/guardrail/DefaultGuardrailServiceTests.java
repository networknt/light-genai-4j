...
class DefaultGuardrailServiceTests {
    ...
    void classLevelGuardrailsNoBuilders() {
        ...
        assertThat(guardrailService.getOutputConfig("chat"))
                .get()
                .extracting(com.networknt.agent.guardrail.config.OutputGuardrailsConfig::maxRetries)
                .isEqualTo(com.networknt.agent.guardrail.config.OutputGuardrailsConfig.MAX_RETRIES_DEFAULT);
                ...
                Arguments.of(
                        ...
                        GuardrailService.builder(MethodLevelAssistant1.class)
                                ...
                                .outputGuardrailsConfig(
                                        com.networknt.agent.guardrail.config.OutputGuardrailsConfig.builder()
                                                .maxRetries(10)
                                                .build())
                                .build()),
                Arguments.of(
