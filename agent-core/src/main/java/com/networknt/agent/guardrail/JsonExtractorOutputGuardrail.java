...
import com.networknt.agent.internal.JsonParsingUtils;
 ...
 * *             Add a dependency on `com.networknt.agent:langchain4j-guardrails` and use the class from that module instead.
 */
