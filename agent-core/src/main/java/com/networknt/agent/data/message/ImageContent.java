...
import static com.networknt.agent.data.message.ContentType.IMAGE;
import static com.networknt.agent.internal.ContentUtil.extractBase64Content;
import static com.networknt.agent.data.message.ImageContent.DetailLevel.LOW;
