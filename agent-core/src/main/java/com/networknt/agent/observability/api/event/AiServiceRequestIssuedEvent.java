package com.networknt.agent.observability.api.event;

import com.networknt.agent.invocation.InvocationContext;
import com.networknt.agent.model.chat.request.ChatRequest;
import com.networknt.agent.observability.event.DefaultAiServiceRequestIssuedEvent;
import com.networknt.agent.observability.event.DefaultAiServiceResponseReceivedEvent;

/**
 * Invoked just before a {@link com.networknt.agent.model.chat.request.ChatRequest} is sent.
