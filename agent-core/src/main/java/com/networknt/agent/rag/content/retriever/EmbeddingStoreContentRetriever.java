...
import static com.networknt.agent.internal.ValidationUtils.ensureBetween;
...
import com.networknt.agent.rag.content.ContentMetadata;
 ...
 * the user (using Metadata#chatMemoryId()} from {@link Query#metadata()}), etc.
 * <br>
 * - {@code filter}: The {@link Filter} that will be applied to a {@link com.networknt.agent.data.document.Metadata} in the
