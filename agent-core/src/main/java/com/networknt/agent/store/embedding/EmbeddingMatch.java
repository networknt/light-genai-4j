 ...
 *
 * @param <Embedded> The class of the object that has been embedded. Typically, it is {@link com.networknt.agent.data.segment.TextSegment}.
 */
public class EmbeddingMatch<Embedded> {
     ...
     * @param embedded The original content that was embedded. Typically, this is a {@link com.networknt.agent.data.segment.TextSegment}.
     */
     ...
     * @return The original content that was embedded. Typically, this is a {@link com.networknt.agent.data.segment.TextSegment}.
     */
