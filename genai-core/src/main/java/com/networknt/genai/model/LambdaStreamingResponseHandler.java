 ...
 * Example:
 * <pre>
 * import static com.networknt.genai.model.LambdaStreamingResponseHandler.*;
 *
...
public class LambdaStreamingResponseHandler {
     ...
     * @return the streaming chat response handler
     */
     ...
     *
     * @param onPartialResponseLambda consumer to handle each partial response
     * @param onErrorLambda consumer to handle errors
     * @return the streaming chat response handler
     */
