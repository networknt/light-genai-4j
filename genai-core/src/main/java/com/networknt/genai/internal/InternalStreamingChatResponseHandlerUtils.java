...
/**
 * Internal utilities for {@link StreamingChatResponseHandler}.
 */
@Internal
public class InternalStreamingChatResponseHandlerUtils {
    ...
    private InternalStreamingChatResponseHandlerUtils() {}

    /**
     * Runs the runnable and logs any exceptions.
     *
     ...
     * @param partialResponse the partial response
     */
    ...
    /**
     * Invokes {@link StreamingChatResponseHandler#onPartialResponse(PartialResponse, PartialResponseContext)}.
     *
     * @param handler the handler
     * @param partialResponse the partial response
     * @param streamingHandle the streaming handle
     * @since 1.8.0
     */
     ...
     *
     * @param handler the handler
     * @param partialThinking the partial thinking
     */
    @Deprecated(forRemoval = true, since = "1.8.0")
    ...
    /**
     * Invokes {@link StreamingChatResponseHandler#onPartialThinking(PartialThinking, PartialThinkingContext)}.
     *
     * @param handler the handler
     * @param partialThinking the partial thinking
     * @param streamingHandle the streaming handle
     ...
     *
     * @param handler the handler
     * @param partialToolCall the partial tool call
     */
    @Deprecated(forRemoval = true, since = "1.8.0")
    ...
    /**
     * Invokes {@link StreamingChatResponseHandler#onPartialToolCall(PartialToolCall, PartialToolCallContext)}.
     *
     * @param handler the handler
     * @param partialToolCall the partial tool call
     * @param streamingHandle the streaming handle
    ...
    /**
     * Invokes {@link StreamingChatResponseHandler#onCompleteToolCall(CompleteToolCall)}.
     *
     * @param handler the handler
     * @param completeToolCall the complete tool call
     */
    ...
    /**
     * Invokes {@link StreamingChatResponseHandler#onCompleteResponse(ChatResponse)}.
     *
     * @param handler the handler
