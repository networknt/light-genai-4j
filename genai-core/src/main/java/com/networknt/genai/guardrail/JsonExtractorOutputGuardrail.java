...
import com.networknt.genai.internal.JsonParsingUtils;
 ...
 * *             Add a dependency on `com.networknt.genai:langchain4j-guardrails` and use the class from that module instead.
 */
