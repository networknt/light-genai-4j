...
import static com.networknt.genai.model.ollama.OllamaImage.TINY_DOLPHIN_MODEL;
...
class OllamaStreamingChatModelIT extends AbstractOllamaLanguageModelInfrastructure {
    ...
    void should_generate_valid_json() {
        ...
        com.networknt.genai.model.chat.response.ChatResponse response = handler.get();
        String answer = response.aiMessage().text();
    ...
    @ParameterizedTest
    @MethodSource("com.networknt.genai.model.ollama.OllamaChatModelIT#notSupportedContentTypesProvider")
    void should_throw_when_not_supported_content_types_used(List<ContentType> contentTypes) {
        ...
        assertThrows(com.networknt.genai.exception.UnsupportedFeatureException.class, () -> model.chat(List.of(userMessage), handler));
    }

    @ParameterizedTest
    @MethodSource("com.networknt.genai.model.ollama.OllamaChatModelIT#supportedContentTypesProvider")
