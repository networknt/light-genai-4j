...
import com.networknt.genai.http.client.HttpMethod;
...
import com.networknt.genai.http.client.sse.DefaultServerSentEventParser;
...
import com.networknt.genai.internal.InternalStreamingChatResponseHandlerUtils;
...
class OpenAiResponsesClient {
    ...
    private String toToolChoiceString(com.networknt.genai.model.chat.request.ToolChoice toolChoice) {
        if (toolChoice == null) {
            return null;
        }
    ...
    private Map<String, Object> toResponseTextConfig(
            com.networknt.genai.model.chat.request.ResponseFormat responseFormat, boolean strict) {
        if (responseFormat == null
                || responseFormat.type() == com.networknt.genai.model.chat.request.ResponseFormatType.TEXT) {
            return null;
        }

        var textConfig = new HashMap<String, Object>();
        com.networknt.genai.model.chat.request.json.JsonSchema jsonSchema = responseFormat.jsonSchema();
        ...
        if (jsonSchema == null) {
            ...
            if (!(jsonSchema.rootElement() instanceof com.networknt.genai.model.chat.request.json.JsonObjectSchema
                    || jsonSchema.rootElement() instanceof com.networknt.genai.model.chat.request.json.JsonRawSchema)) {
