...
import static com.networknt.model.openaiofficial.microsoftfoundry.InternalMicrosoftFoundryTestHelper.EMBEDDING_MODEL_NAME;
...
class MicrosoftFoundryEmbeddingModelIT {
    ...
    protected List<com.networknt.agent.model.embedding.EmbeddingModel> models() {
