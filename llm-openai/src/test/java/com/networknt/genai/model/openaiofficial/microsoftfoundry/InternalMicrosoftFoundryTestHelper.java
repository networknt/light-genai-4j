...
import com.networknt.genai.model.image.ImageModel;
...
import com.networknt.genai.model.openaiofficial.OpenAiOfficialImageModel;
...
public class InternalMicrosoftFoundryTestHelper {
    ...
    static List<com.networknt.genai.model.embedding.EmbeddingModel> embeddingModels() {
        List<com.networknt.genai.model.embedding.EmbeddingModel> models = new ArrayList<>();
