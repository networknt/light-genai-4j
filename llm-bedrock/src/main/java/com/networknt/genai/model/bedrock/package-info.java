 ...
 * <h2>Key Classes</h2>
 * <ul>
 *   <li>{@link com.networknt.genai.model.bedrock.BedrockChatModel} - Synchronous chat model</li>
 *   <li>{@link com.networknt.genai.model.bedrock.BedrockStreamingChatModel} - Streaming chat model</li>
 *   <li>{@link com.networknt.genai.model.bedrock.BedrockChatRequestParameters} - Bedrock-specific parameters</li>
 * </ul>
 *
 ...
 *
 * <h3>1. Simple Caching with {@link com.networknt.genai.model.bedrock.BedrockCachePointPlacement}</h3>
 ...
 * }</pre>
 *
 * <h3>2. Granular Caching with {@link com.networknt.genai.model.bedrock.BedrockSystemMessage}</h3>
 ...
 * <p><b>Important:</b> {@link com.networknt.genai.model.bedrock.BedrockSystemMessage} implements
 * {@link com.networknt.genai.data.message.ChatMessage} but does NOT extend
 * {@link com.networknt.genai.data.message.SystemMessage}. This has implications:</p>
 * <ul>
 ...
 * </ul>
 * <p>Use {@link com.networknt.genai.model.bedrock.BedrockSystemMessage#toSystemMessage()} to convert
 * to a core SystemMessage when needed (cache points will be lost).</p>
 *
 * @see com.networknt.genai.model.bedrock.BedrockChatModel
 * @see com.networknt.genai.model.bedrock.BedrockStreamingChatModel
 * @see com.networknt.genai.model.bedrock.BedrockSystemMessage
 * @see com.networknt.genai.model.bedrock.BedrockCachePointPlacement
