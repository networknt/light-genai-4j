...
import static com.networknt.genai.internal.Utils.copyIfNotNull;
...
import static com.networknt.genai.model.ModelProvider.AZURE_OPEN_AI;
import static com.networknt.genai.model.azure.InternalAzureOpenAiHelper.setupAsyncClient;
import static com.networknt.genai.model.azure.InternalAzureOpenAiHelper.toAzureOpenAiResponseFormat;
import static com.networknt.genai.model.azure.InternalAzureOpenAiHelper.toOpenAiMessages;
import static com.networknt.genai.model.azure.InternalAzureOpenAiHelper.toToolChoice;
import static com.networknt.genai.model.azure.InternalAzureOpenAiHelper.toToolDefinitions;
import static com.networknt.genai.model.azure.InternalAzureOpenAiHelper.validate;
...
import com.networknt.genai.model.azure.spi.AzureOpenAiStreamingChatModelBuilderFactory;
...
public class AzureOpenAiStreamingChatModel implements StreamingChatModel {
    ...
    private static boolean startOfNewToolCall(ChatCompletionsToolCall toolCall) {
        return toolCall.getId() != null; // Azure OpenAI includes ID only at the start of a tool call
    }
