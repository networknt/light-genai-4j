...
import static com.networknt.genai.data.message.ToolExecutionResultMessage.toolExecutionResultMessage;
import static com.networknt.genai.data.message.UserMessage.userMessage;
import static com.networknt.genai.model.azure.AzureOpenAiChatModelName.GPT_3_5_TURBO_0613;
import static com.networknt.genai.model.azure.AzureOpenAiChatModelName.GPT_3_5_TURBO_1106;
import static com.networknt.genai.model.azure.AzureOpenAiChatModelName.GPT_4_0125_PREVIEW;
import static com.networknt.genai.model.azure.AzureOpenAiChatModelName.GPT_4_0613;
import static com.networknt.genai.model.azure.AzureOpenAiChatModelName.GPT_4_1106_PREVIEW;
import static com.networknt.genai.model.azure.AzureOpenAiChatModelName.GPT_4_32K;
import static com.networknt.genai.model.azure.AzureOpenAiChatModelName.GPT_4_32K_0613;
import static com.networknt.genai.model.azure.AzureOpenAiChatModelName.GPT_4_TURBO_2024_04_09;
import static com.networknt.genai.model.azure.AzureOpenAiChatModelName.GPT_4_VISION_PREVIEW;
...
class AzureOpenAiTokenCountEstimatorIT {
    ...
    private static final Set<AzureOpenAiChatModelName> MODELS_WITHOUT_ACCESS =
            new HashSet<>(asList(GPT_3_5_TURBO_0613, GPT_4_32K, GPT_4_32K_0613));

    private static final Set<AzureOpenAiChatModelName> MODELS_WITHOUT_TOOL_SUPPORT =
            new HashSet<>(asList(GPT_4_0613, GPT_4_VISION_PREVIEW));

    private static final Set<AzureOpenAiChatModelName> MODELS_WITH_PARALLEL_TOOL_SUPPORT =
            new HashSet<>(asList(GPT_3_5_TURBO_1106, GPT_4_TURBO_2024_04_09, GPT_4_1106_PREVIEW, GPT_4_0125_PREVIEW));
    ...
    static Stream<Arguments> should_count_tokens_in_messages() {
        return stream(AzureOpenAiChatModelName.values())
                ...
                .flatMap(model -> Stream.of(
                        ...
                        arguments(asList(systemMessage("Be helpful"), userMessage("hi")), model),
                        arguments(
                                asList(
    ...
    @ParameterizedTest
    @MethodSource
    void should_count_tokens_in_messages_with_single_tool(
            List<ChatMessage> messages, AzureOpenAiChatModelName modelName) {
                        ...
                        arguments(
                                asList(
                                        aiMessage(ToolExecutionRequest.builder()
                                                ...
                                                .name("current_time")
                                                .arguments(
                                                        "{\"city\":\"Berlin\",\"country\":\"Germany\",\"format\":\"24\"}")
                                                .build()),
                                        toolExecutionResultMessage("a", null, "23:59")),
                                model),
    ...
    @ParameterizedTest
    @MethodSource
    void should_count_tokens_in_messages_with_multiple_tools(
            List<ChatMessage> messages, AzureOpenAiChatModelName modelName) {
        // given
        AzureOpenAiChatModel model = AzureModelBuilders.chatModelBuilder()
                .deploymentName(modelName.toString())
                                ...
                                asList(
                                        aiMessage(
                                                ...
                                                ToolExecutionRequest.builder()
                                                        ...
                                                        .name("current_temperature")
                                                        .arguments(
                                                                "{\"city\":\"Berlin\",\"country\":\"Germany\",\"unit\":\"C\"}")
                                                        .build()),
                                        toolExecutionResultMessage("a", null, "1"),
                                        toolExecutionResultMessage("b", null, "2")),
                                model),
